...
insert ignore into geoname(place_name,latitude,longitude,location_id,gazetteer_adm_code,gazetteer_adm_name,location_class,geographic_exactness)
select gt.place_name, gt.latitude, gt.longitude, l.location_id, gt.gazetteer_adm_code, gt.gazetteer_adm_name, gt.location_class, gt.geographic_exactness
from geoname_temp as gt
inner join location as l on gt.location_type_code = l.location_type_code;

insert into country_code (name,iso2, name_aiddata_code, name_cow_alpha, name_cow_numeric, name_fao_code, name_fips, name_geoname_id, name_imf_code,name_iso3)
select distinct name,iso2, name_aiddata_code, name_cow_alpha, name_cow_numeric, name_fao_code, name_fips, name_geonames_id, name_imf_code,name_iso3
...
inner join country_code as cct on pt.recipients_iso3 = cct.name_iso3 ;
